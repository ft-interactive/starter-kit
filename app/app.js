...
import ArticleLayout from '@financial-times/g-components/article-layout';
import { StoryTopper } from '@financial-times/g-components/story-topper';
import { GridContainer, GridRow, GridChild } from '@financial-times/g-components/grid';
        ...
        <GridRow>
          <GridChild colspan="12 S11 Scenter M10 L9 XL8">
            ...
            <p>
              ...
              kuƿīgi preÞerito. Kiǣ us vendo kiomæs sezōnonōmo, for si vidalvīde punkÞōkomo geiƿsÞrūisto.
            </p>
            ...
            <p>
              ...
              nēniæĵō eksteren mia is, pako mīloj demanðosignō vir je, grupǽ kromakcento iu meƿ. Ido Þiǽl
              kōmbi fræto po, ko iēs vǽto ġlotā lǽndonomo, he vīc ēkōo ƿanō. Anƿo sekviƿȝero uk tet, us
              mekæo iomete træ. Int co onjo finnlæƿðo subjunkċiō, kaj faka eblecō mīnimumē ōƿ. Ore verba
              ðuonhoro komplēksā il, hierāŭæ propōzicio ÞīudīrēkÞen iz sur.
            </p>
